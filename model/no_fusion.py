...
class NoFusionFixerUNet(nn.Module):
    """
    No-fusion model: ignores error maps and predicts delta only from CT+initial mask.
    """

    def __init__(self, in_channels: int = 2, base_channels: int = 8, norm: str = "INSTANCE"):
        super().__init__()
        c = base_channels
