...
class NoCTCrossAttnFixerUNet(nn.Module):
    """
    Cross-attention fixer without CT: main input is initial seg only.
    """

    def __init__(self, in_channels: int = 1, err_channels: int = 2, base_channels: int = 8, norm: str = "INSTANCE"):
        super().__init__()
        c = base_channels
...
__all__ = ["NoCTCrossAttnFixerUNet"]
