# Archived TfeNet–AeroPath reanalysis notes

> Per MICCAI policy, the open-access source package must not introduce new experiments, training, or data. All values below are therefore derived solely from reanalysis of the archived predictions and evaluation outputs generated for the submitted manuscript.
